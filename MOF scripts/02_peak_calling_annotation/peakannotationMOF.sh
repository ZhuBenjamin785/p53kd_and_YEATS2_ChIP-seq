...
project_dir="${MOF_PROJECT_DIR:-/projects/b1042/LauberthLab/BenFolder}"
[[ -d "${project_dir}" ]] || {
...
human_bam_dir="${MOF_BAM_DIR:-${project_dir}/MOF_bamfiles/human}"
dm6_bam_dir="${MOF_DM6_BAM_DIR:-${project_dir}/MOF_bamfiles/dm6}"
outdir="${MOF_PEAK_DIR:-${project_dir}/mof_macs3_results}"
samtools_threads=8
...
annotation_script="${project_dir}/chipseekerannotation.r"
[[ -s "${annotation_script}" ]] || {
