...
default_results = project_dir / "shared" / "rna_seq_dea" / "shp53_vs_shLacZ_0hr" / "results.csv"
default_output = project_dir / "shared" / "rna_seq_dea" / "fea"


def choose_gene_column(df):
    for column in ("gene_name", "Geneid", "gene", "symbol", "Unnamed: 0"):
