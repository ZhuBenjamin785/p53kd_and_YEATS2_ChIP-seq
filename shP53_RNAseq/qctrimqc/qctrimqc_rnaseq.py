...
def main():
    ...
    inputdir = os.environ.get(
        "SHP53_FASTQ_DIR", f"{project}/shared/FASTQ/shP53_SRA_single_end"
    )
    trimmeddir = os.environ.get(
        "SHP53_TRIMMED_DIR", f"{project}/shared/rnaseqtrimmeddir/shP53_SRA_single_end"
    )
    fastqcdir = os.environ.get(
        "SHP53_FASTQC_DIR", f"{project}/shared/rnaseqfastqcdir/shP53_SRA_single_end"
    )
    multiqcdir = os.environ.get(
        "SHP53_MULTIQC_DIR", f"{project}/shared/rnaseqresults/shP53_SRA_single_end"
    )
