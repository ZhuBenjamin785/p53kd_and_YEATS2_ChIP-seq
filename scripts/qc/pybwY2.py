...
"""Rank protein-coding genes by H4K16ac change from Scramble to YEATS2 KD."""
...
mplconfigdir = Path("/tmp/pybwY2-mplconfig")
...
tracks = {
    "Scramble_rep1": "bamcompareY2/Scramble_YEATS2_rep1_ChIP_vs_Input_log2.bw",
    "Scramble_rep2": "bamcompareY2/Scramble_YEATS2_rep2_ChIP_vs_Input_log2.bw",
    "KD_rep1": "bamcompareY2/YEATS2KD_rep1_ChIP_vs_Input_log2.bw",
    "KD_rep2": "bamcompareY2/YEATS2KD_rep2_ChIP_vs_Input_log2.bw",
}
outdir = Path("yeats2_shift_results")
promoterbp = 2000
top_n = 50
...
def make_plots(table, region):
    ...
    with PdfPages(outdir / f"{region}_shift_plots.pdf") as pdf:
        ...
        for ax, rows, label in [(axes[0], gained, "gained"), (axes[1], lost, "lost")]:
            ...
            ax.plot(x, tss_profile(rows, kd_paths), label="YEATS2 KD", color="red")
            ax.axvline(0, color="grey", ls="--", lw=1)
...
def plot_ratio_logfc(table):
    ...
    ax.set_ylabel("Gene")
    ax.set_title("H4K16ac redistribution after YEATS2 KD")
