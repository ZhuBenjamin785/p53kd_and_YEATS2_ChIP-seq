...
annotation_paths <- c(
  file.path(project_dir, "chipseq_summary_plots/YEATS2KD/diffbind_peak_annotations.csv"),
  file.path(project_dir, "chipseq_summary_plots/p53KD/diffbind_peak_annotations.csv")
)
